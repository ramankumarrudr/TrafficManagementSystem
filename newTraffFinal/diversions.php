...
<html>
 ...
 <body>
  ...
  <div class="container">
   <br />
   <h2 align="center" style="color:#EC80FF">Area wise Diversions</h2><br />

   <select name="multi_search_filter" id="multi_search_filter" multiple class="form-control selectpicker">
     <option value="" disabled selected>Select the area and find the diversions-</option>
   <?php
...
$(document).ready(function(){
 ...
 //load_data(); //to hide the initial data
